...
KUBERNETES_KEYPAIR_NAME=eddysputykeyathome

# Kubernetes release tar file
KUBERNETES_RELEASE_TAR=${KUBERNETES_RELEASE_TAR:-kubernetes-server-linux-amd64.tar.gz}

NUMBER_OF_MINIONS=${NUMBER_OF_MINIONS:-2}

MAX_NUMBER_OF_MINIONS=${MAX_NUMBER_OF_MINIONS:-3}

MASTER_FLAVOR=${MASTER_FLAVOR:-c2m2}

MINION_FLAVOR=${MINION_FLAVOR:-c2m2}

EXTERNAL_NETWORK=${EXTERNAL_NETWORK:-lab_uplink}
